...
| `image.tag`                              | image tag (immutable tags are recommended)                                                                                                                                                                 | `v1.31.1`         |
...
| `mailpit.smtp.tls.method`                | TLS certificate source: generated by Mailpit (`auto`), cert-manager (`cert-manager`) or an existing Secret (`secret`)                                                                                       | `secret`          |
| `mailpit.smtp.tls.secretName`            | Existing TLS Secret for SMTP when method is secret                                                                                                                                                         | `""`              |
| `mailpit.smtp.tls.auto.dnsNames`         | DNS names included in the certificate generated by Mailpit. Defaults to the SMTP Service names                                                                                                             | `[]`              |
| `mailpit.smtp.tls.certManager.dnsNames`  | DNS names included in the certificate. Defaults to the SMTP Service names                                                                                                                                  | `[]`              |
| `mailpit.smtp.tls.certManager.issuerRef` | cert-manager issuer for the certificate                                                                                                                                                                    | `{}`              |
