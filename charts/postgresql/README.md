...
helm install mailpit jouve/postgresql
```
...
| `affinity.topologyKey`                         | Node label key used by CNPG-rendered pod anti-affinity. CNPG defaults to topology.kubernetes.io/zone, which is a no-op on bare-metal clusters without zone labels — pick kubernetes.io/hostname to spread across nodes. | `kubernetes.io/hostname`         |
| `image.registry`                               | image registry                                                                                                                                                                                                          | `ghcr.io`                        |
| `image.repository`                             | image repository                                                                                                                                                                                                        | `cloudnative-pg/postgresql`      |
| `image.tag`                                    | image tag (immutable tags are recommended)                                                                                                                                                                              | `17.5-22`                        |
...
| `backup.pluginName`                            | Name of the registered CNPG plugin handling backups                                                                                                                                                                     | `barman-cloud.cloudnative-pg.io` |
...
| `backup.retentionPolicy`                       | Retention for backups (used by the plugin to drive barman cleanup)                                                                                                                                                      | `7d`                             |
